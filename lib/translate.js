...
var getEnglishTranslatePath = function (lang, text) {
  ...
  var input = languages[lang.input] || '',
...
if(typeof exports === 'undefined'){
  ...
  exports.text = function (lang, text, callback) {
    ...
    request(requestOptions, function(err, resp, body){
      ...
      if (data.responseData.detectedSourceLanguage == null){
		var language = lang.input;
	  }
	  else{
		language = data.responseData.detectedSourceLanguage; //needs short => long conversion
	  }

      callback(null, data.responseData.translatedText, language);
    });
  }
}
